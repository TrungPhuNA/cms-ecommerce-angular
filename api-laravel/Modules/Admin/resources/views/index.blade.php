                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap gap-4">
                                        ...
                                        <div class="d-flex align-items-center fw-bolder">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Select-->
                                            <select class="form-select form-select-transparent text-graY-800 fs-base lh-1 fw-bolder py-0 ps-3 w-auto"
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-3"
                                    ...
                                    <tr data-kt-table-widget-4="subtable_template" class="d-none">
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="text-muted fs-7 fw-bolder"
                                                 data-kt-table-widget-4="template_total">name
                                            </div>
                                        </td>
                                        <td class="text-end">
                                            <div class="text-gray-800 fs-7 me-3">On hand</div>
                                            <div class="text-muted fs-7 fw-bolder"
                                                 data-kt-table-widget-4="template_stock">32
                                            </div>
                                        </td>
                                        <td></td>
                                    </tr>
